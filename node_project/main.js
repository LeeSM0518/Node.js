...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="node_project.html">Node.js Project</a>
    </div>
  </nav>
        ...
        <div class="post-preview">
          <a>
            ...
            <h3 class="post-subtitle">
              Bootstrap에서 html 코드를 가져와서 편집하여 블로그 외면 제작
            </h3>
            <a href ="/delete" class="btn btn-danger float-right">delete</a>
            <a href ="/adjust" class="btn btn-secondary float-right">Adjust</a>
          </a>
